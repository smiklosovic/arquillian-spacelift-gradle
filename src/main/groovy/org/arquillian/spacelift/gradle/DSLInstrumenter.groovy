...
class DSLInstrumenter {
    ...
    private static Logger logger = LoggerFactory.getLogger(DSLInstrumenter)

    /**
     * Generate methods handling {@link DeferredValue} and @{link InheritanceAwareContainer}* fields in the {@code object}
     *
    ...
    static void generateDeferredValueMethods(Object object) {
        availableDeferredValues(object.getClass()).each { Field field ->
            ...
            if (!object.metaClass.respondsTo(object, field.name, Object[].class)) {
                ...
                logger.debug("Created DSL setter ${object.getClass().getSimpleName()}#${field.name}(Object...)")
            }
            ...
            if (!object.metaClass.respondsTo(object, getterName, null)) {
                ...
                logger.debug("Created DSL getter ${object.getClass().getSimpleName()}#${getterName}()")
            }
        }
    }
